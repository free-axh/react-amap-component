...
declare module AMap {
    ...
    export class Map {
      ...
      getCity(callback: (province: string, city: string,
        citycode: string, district: string) => void): void;
    ...
    export interface InfoWindowOptions {
      /**是否自定义窗体。
       * 设为true时，信息窗体外框及内容完全按照content所设的值添加（默认为false，即在系统默认的信息窗体外框中显示content内容）
       * **/
      isCustom?: boolean;
      ...
      /**
       * 控制是否在鼠标点击地图后关闭信息窗体
      * 默认false，鼠标点击地图后不关闭信息窗体
      * **/
      closeWhenClickMap?: boolean;
  
      /**
       * 显示内容
       * 可以是HTML要素字符串或者HTMLElement对象
       * */
      content?: string|HTMLElement;
  
      /**
       * 信息窗体尺寸
       * isCustom为true时，该属性无效）
       * **/
      size?: Size;
      ...
      /**
       * Boolean 控制是否显示信息窗体阴影
       * 取值false时不显示窗体阴影，取值true时显示窗体阴影,默认值：false
       * **/
      showShadow?: boolean;
    }
    ...
    export class InfoWindow {
      /**构造信息窗体对象, 通过InfoWindowOptions指定信息窗体样式**/
